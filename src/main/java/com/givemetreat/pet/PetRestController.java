...
public class PetRestController {
	...
	@ApiResponses({
		@ApiResponse(responseCode = "500__1", description = "error_message: \"등록 가능 프로필 갯수가 초과하였습니다. 최대 5개의 반려견 프로필을 등록할 수 있습니다.\"", content = @Content(mediaType = "APPLICATION_JSON"))
		, @ApiResponse(responseCode = "500__2", description = "error_message: \"기존 이름과 중복됩니다.\"", content = @Content(mediaType = "APPLICATION_JSON"))
		, @ApiResponse(responseCode = "500__3", description = "error_message: \"해당 반려견 정보를 추가하지 못 하였습니다.\"", content = @Content(mediaType = "APPLICATION_JSON"))
	...
	@ApiResponses({
		@ApiResponse(responseCode = "500__1", description = "error_message: \"등록 가능 프로필 갯수가 초과하였습니다. 최대 5개의 반려견 프로필을 등록할 수 있습니다.\"", content = @Content(mediaType = "APPLICATION_JSON"))
		, @ApiResponse(responseCode = "500__2", description = "error_message: \"해당 반려견 정보가 존재하지 않습니다.\"", content = @Content(mediaType = "APPLICATION_JSON"))
		, @ApiResponse(responseCode = "500__3", description = "error_message: \"기존 이름과 중복됩니다.\"", content = @Content(mediaType = "APPLICATION_JSON"))
		, @ApiResponse(responseCode = "500__4", description = "error_message: \"해당 반려견 정보를 수정하지 못하였습니다.\"", content = @Content(mediaType = "APPLICATION_JSON"))
		, @ApiResponse(responseCode = "200", description = "result: \"success\"", content = @Content(mediaType = "APPLICATION_JSON"))
	})
	...
	@ApiResponses({
		@ApiResponse(responseCode = "500__1", description = "error_message: \"해당 반려견 정보가 존재하지 않습니다.\"", content = @Content(mediaType = "APPLICATION_JSON"))
		, @ApiResponse(responseCode = "500__2", description = "error_message: \"해당 반려견 정보를 삭제하지 못하였습니다.\"", content = @Content(mediaType = "APPLICATION_JSON"))
		, @ApiResponse(responseCode = "200", description = "result: \"success\"", content = @Content(mediaType = "APPLICATION_JSON"))
	})
